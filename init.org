...
[[https://www.reddit.com/r/emacs/comments/1j0m18u/emacs_flashing_white_at_startup/][Stop the screen flashing white on startup]]
...
; The following don't work if included in above `use-package emacs`
...
/Iosevka Extended/ (see next para) is a nice font, [[https://phd-sid.ethz.ch/debian/fonts-iosevka/fonts-iosevka_22.0.0%2Bds-1_all.deb][downloadable]] as a .deb.
/Source Code Pro/ is another option. /Noto Mono/ would be nice, if it had
/italics/.

Nerd fonts can also be used. There's a huge selection at [[https://www.nerdfonts.com/][Nerd Fonts]],
including Iosevka.
...
(let ((ht 160)
      ...
      (fix "SauceCodePro Nerd Font Medium")
      (var "Cantarell"))
...
Local snippets are stored ~etc/yasnippet/~
